...
function AppContent() {
  ...
  return (
    <div 
      className={`min-h-screen transition-all duration-500 font-sans overflow-x-hidden relative ${selectedDetailedHeritageId ? "text-[#05461a] animate-fade-in" : "text-white"}`} 
